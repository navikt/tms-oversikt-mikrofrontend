...
const jobbLenkerConfig = {
  local: jobbLenkerDev,
  development: jobbLenkerDev,
  production: jobbLenkerProd,
};

const hjelpemidlerLenkerConfig = {
  local: hjelpemidlerLenkerDev,
  development: hjelpemidlerLenkerDev,
  production: hjelpemidlerLenkerProd,
};

const personopplysningLenkerConfig = {
  local: personopplysningLenkerDev,
  development: personopplysningLenkerDev,
  production: personopplysningLenkerProd,
};

const annetLenkerConfig = {
  local: annetLenkerDev,
  development: annetLenkerDev,
  production: annetLenkerProd,
};
