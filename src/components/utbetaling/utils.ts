...
import { Trekk, UnderYtelse, UtbetalingResponse } from "./types";

export const hasUtbetalinger = (utbetalinger: UtbetalingResponse) => !Array.isArray(utbetalinger) || utbetalinger.length == 0;
