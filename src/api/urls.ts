...
export const syfoAktivitetManifestUrl = `${SYFO_AKTIVITET_BASE_URL[getEnvironment()]}/manifest.json`;
export const syfoAktivitetCdnUrl = SYFO_AKTIVITET_CDN_URL[getEnvironment()];
